...
function renderAdoptionReport(scan, compatibility) {
    return [
        "# Adoption Report",
        "",
...
async function migrateConfigContent(rootDirectory) {
...
async function buildAdoptionPlan(rootDirectory, includeMigration) {
...
export async function planAdoption(rootDirectory, options = {}) {
    return (await buildAdoptionPlan(rootDirectory, options.includeMigration ?? true)).plan;
}
export async function adoptRepository(rootDirectory, options = {}) {
