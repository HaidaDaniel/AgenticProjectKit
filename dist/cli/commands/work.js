...
import { parseWorkerRole, parseWorkerResult, parseWorkerStatus, recordWorkerResult, renderWorkResult, renderWorkerRunResult, startWork, WORKER_PROTOCOL, WORKER_ROLES, } from "../../core/work/index.js";
...
async function runWorkResultCommand(argv) {
    if (hasHelpFlag(argv)) {
        console.log(WORK_HELP_TEXT);
        return 0;
    }
