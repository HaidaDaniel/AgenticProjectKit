...
Task provenance traces implementation runs, baseline, commits/diff, verification, review and completion evidence end to end.
...
2. Expose per-task human/machine provenance output including multiple implementation/fixer runs.
...
- Final completion references exact evidence used by gate.
